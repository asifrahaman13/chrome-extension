...
// const aws_skds=require("./aws_sdk.js");

// Load the AWS SDK for Node.js
// var AWS = require('aws-sdk');
// Define your AWS credentials (replace with your own values)

const awsAccessKeyId = "AKIAQGXPVEL3XSCBBL7X";
const awsSecretAccessKey = "PYV8Nx0k5VRqg33bM4hWLgM+Ik28HOQ3+GWnua/Y";
const s3BucketName = "asif-cognita-test-bucket";
...
function uploadToS3(blob) {
  const params = {
    Bucket: s3BucketName,
    Key: "screen-recording.webm", // The name you want to use for the file in S3
    Body: blob,
  };
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  ...
  if (message.action === "stopvideo") {
    ...
    // Upload the recorded video to S3
    recorder.ondataavailable = function (event) {
      let recordedBlob = event.data;
